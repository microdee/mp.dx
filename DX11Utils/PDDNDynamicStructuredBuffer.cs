...
namespace mp.dx.dx11.Nodes
{
    ...
    public class DynamicPinDynamicStructuredBuffer : ConfigurableDynamicPinNode<string>, IPluginEvaluate, IDisposable, IDX11ResourceHost
    {
        ...
        protected override void OnConfigPinChanged()
        {
            ...
            foreach (var pair in typenamepairs)
            {
                ...
                try
                {
                    ...
                    Enum.TryParse(pair.Item1, true, out typesig);
